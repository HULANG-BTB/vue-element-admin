  ...
  <div class="content">
    <el-form :inline="true" :model="queryData">
      ...
      <el-form-item label="是否启用：">
        <el-select v-model="queryData.fIsEnable" placeholder="请选择部门状态 " size="small">
    ...
    <el-dialog :title="formTitle" :visible.sync="dialogFormVisible" @close="handleClose">
      <el-form ref="popForm" :model="saveData" :rules="popForm.rules" label-width="120px">
        <el-form-item label="部门名称" prop="fFindeptName">
          <el-input v-model="saveData.fFindeptName" style="width:86% " />
        </el-form-item>
        <el-form-item label="部门编码" prop="fFindeptCode">
          <el-input v-model="saveData.fFindeptCode" style="width:86% " />
        </el-form-item>
        ...
        <el-form-item label="联系人" prop="fLinkman">
          <el-input v-model="saveData.fLinkman" style="width:86% " />
        </el-form-item>
        <el-form-item label="联系人电话" prop="fLinkTel">
          <el-input v-model="saveData.fLinkTel" style="width:86% " />
        </el-form-item>

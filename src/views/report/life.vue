<template>
  <div>
    ...
    <div id="main1" style="width:800px;height:450px" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    drawLine (id) {
      ...
      this.dataMap.dataTI = this.dataFormatter({
        // max : 25000,
      ...
      this.dataMap.dataEstate = this.dataFormatter({
        // max : 3600,
      ...
      this.dataMap.dataFinancial = this.dataFormatter({
        // max : 3200,
        ...
        options: [
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2002sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2002sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2002sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2003sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2003sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2003sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2004sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2004sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2004sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2005sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2005sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2005sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2006sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2006sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2006sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2007sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2007sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2007sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2008sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2008sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2008sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2009sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2009sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2009sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2010sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2010sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2010sum'] }
              ] }
            ]
          },
          {
            ...
            series: [
              ...
              { data: [
                { name: '第一产业', value: this.dataMap.dataPI['2011sum'] },
                { name: '第二产业', value: this.dataMap.dataSI['2011sum'] },
                { name: '第三产业', value: this.dataMap.dataTI['2011sum'] }
              ] }
            ]
          }
        ]
